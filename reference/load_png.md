...
This function adds a helper method, `LoadPNG`, to the C# script. This
function is typically used by other C# methods to bring in textures into
a Unity scene, for instance by functions like
