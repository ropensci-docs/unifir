...
This outlines how to propose a change to unifir. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("mikemahoney218/unifir", fork = TRUE)`.
...
of Conduct](https://docs.ropensci.org/unifir/CODE_OF_CONDUCT.md). By
